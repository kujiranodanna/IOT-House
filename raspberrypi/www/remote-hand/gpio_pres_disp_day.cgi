#!/bin/bash
# The MIT License
# Copyright (c) 2020-2027 Isamu.Yamauchi , update 2019.6.3
...
<META NAME="Build" content="2019.6.3">
<META NAME="reply-to" content="izamu@pepolinux.jpn.org">
<META http-equiv="Refresh" content="10;URL=/remote-hand/tmp/gpio_pres.png">
<TITLE>GPIO Pressure Graph Create</TITLE>
...
<TR ALIGN=CENTER class="blink"><TD>GPIO Pressure graph create</TD></TR>
</TABLE>
<HR>
...
GRAP_TEMPFILE=${WORKDIR}/tmp/gpio_pres.png
END=`date "+%Y%m%d %H:%M:00" -d "-10 minute"`
END=`date -d "${END}" +%s`
CMD=${WORKDIR}/tmp/gpio_pres.pepocmd
if [ -e ${DSFILE} ];then
  [ -e ${RRDSTART} ] && . ${RRDSTART}
